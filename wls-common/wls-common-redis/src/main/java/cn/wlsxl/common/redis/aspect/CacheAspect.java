package cn.wlsxl.common.redis.aspect;
...
import cn.wlsxl.common.redis.enums.CachePrefixEnum;
...
import static cn.wlsxl.common.redis.enums.CachePrefixEnum.format;
...
public class CacheAspect {
    ...
    public Object around(final ProceedingJoinPoint joinPoint, Cache cache) throws Throwable {
        ...
        try {
            ...
            cacheKey = format(CachePrefixEnum.METHOD_CACHE.getPrefix(), cache.cacheLevel().getLevelFunc().get(), cache.value(), DigestUtil.md5Hex16(joinPointStr));
