package cn.erectpine.elasticsearch.framework.init;
...
//        request.mapping(mpJson, XContentType.JSON);
        ...
        CreateIndexResponse createIndexResponse = es.restHighLevelClient.indices().create(request, RequestOptions.DEFAULT);
